...
public class LoanApplicationServiceImpl implements LoanApplicationService {
	...
	public String validate(int id) {
		...
		if (monthlySalary * 50 < app.getLoanAmount()) {
			...
			String body = "Dear Customer, \n\t Your application for a home loan of ₹ "+ app.getLoanAmount()+" has not been approved by the bank."
					+ "\nThank you.\n";
		...
		String body = "Dear Customer, \n\t  Your application for a home loan of ₹ "+ app.getLoanAmount()+" has been approved by the bank."
